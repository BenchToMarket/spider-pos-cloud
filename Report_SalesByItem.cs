...
public partial class Report_SalesByItem : ReportClass
{

    public Report_SalesByItem() : base()
    {
    }
...
public partial class CachedReport_SalesByItem : Component, ICachedReport
{

    public CachedReport_SalesByItem() : base()
    {
    }
    ...
    {
        var rpt = new Report_SalesByItem();
        rpt.Site = Site;
        return rpt;
    }
